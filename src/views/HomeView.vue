    ...
    <v-container fluid>
        ...
        <v-row>
          <v-col cols="5">
            <div style="position: relative;" class="mt-16">
              ...
              <h1 class="text-white">I'M RIRAN Uishi</h1>
              <span class="text-grey">Web Designer & Engineer</span><br />
          ...
          <v-col cols="5">
            <div style="position: relative;z-index: 9999;" class="mt-16">
              <v-img src="logo-01.png" contain max-height="280"></v-img>
            </div>
          </v-col>
        </v-row>
      </div>
      ...
      <v-col cols="12" sm="12" id="services">
        <div class="d-flex justify-center mb-6">
          ...
          <v-btn class="mr-2" valiant="tonal">Web Design</v-btn>
          <v-btn class="mr-2" valiant="tonal">Front Design</v-btn>
          <v-btn class="mr-2" valiant="tonal">Photography</v-btn>
          <v-btn valiant="tonal">illustration</v-btn>
        </div>
      </v-col>
        ...
        <div class="hire">
          <v-row>
            <v-col cols="12" sm="8">
              ...
              <p class="text-grey">Lorem ipsum dolor sit amet consectectur adipisicing elit.</p>
            </v-col>
            <v-col cols="12" sm="4">
        ...
        <v-row>
          <v-col cols="12" sm="4">
            <div class="child">
              ...
              <span class="text-caption">riran.uishi@gmail.com</span><br />
              <span class="text-caption">riran.uishi@gmail.com</span><br />
            </div>
          </v-col>
          <v-col cols="12" sm="8">
            ...
            <v-divider></v-divider>
            <span class="text-caption">Lorem ipsum.....</span>
            <v-row class="mt-10">
              <v-col cols="12" sm="6">
                <v-text-field label="Name" presistent-hint variant="outlined"></v-text-field>
              </v-col>
              <v-col cols="12" sm="6">
                <v-text-field label="Phone No" presistent-hint variant="outlined"></v-text-field>
              </v-col>
            </v-row>
            <v-textarea label="Message" presistent-hint variant="outlined"></v-textarea>
